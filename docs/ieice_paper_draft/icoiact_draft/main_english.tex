...
\begin{figure}[tb]
    \centerline{\includegraphics[width=0.6\linewidth]{../img/prototype_camera.jpeg}}
...
\begin{figure*}[tb]
    \centerline{\includegraphics[width=0.85\linewidth]{../img/system_flow.png}}
